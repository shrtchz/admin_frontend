...
import TableCurr from '../../utils/TableCurr'
import AddCurrency from '../../utils/AddCurrency'

const url= 'https://shrtchz.pw/api/admin-profile/all-currencies'
const deleteUrl='https://shrtchz.pw/api/admin-profile/delete-currency'
const endpoint="https://shrtchz.pw/api/admin-profile/create-currency"
  ...
  return (
    <>
        ...
        <header className='container-fluid d-flex flex-column justify-content-center'>
          ...
          <AddCurrency isOpen={isModalOpen}  data={fetchData} isClose={handleClose} endpoint={endpoint} authToken={authToken}
          />
        </div>
    </>
  )
