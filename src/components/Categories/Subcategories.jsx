...
import TableSub from '../../utils/TableSub'
import { subcategoryHeaders } from '../../utils/Headers'
import axios from 'axios'
import AddSubCat from '../../utils/AddSubCat'

const url= 'https://shrtchz.pw/api/admin-profile/all-subcategories'
...
const Subcategories = () => {
  ...
  // data.map(dt=>
  //   console.log(dt.category?.name ||"N/A")
  // )
  ...
  return (
    <>
        ...
        <header className='container-fluid d-flex flex-column justify-content-center'>
          ...
          <TableSub data={catData} headers={subcategoryHeaders} selectedRows={selectedRows}  
          setSelectedRows={setSelectedRows}fetchData={fetchData} setData={setCatData}/>
          <AddSubCat isOpen={isModalOpen} data={catData} isClose={handleClose} endpoint={endpoint} authToken={authToken}
          />
        </div>
    </>
  )
