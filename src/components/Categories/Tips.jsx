...
import TableTips from '../../utils/TableTips'
import AddTips from '../../utils/AddTips'
...
const Tips= () => {
  ...
  let res2=await axios.get(`${
    'https://shrtchz.pw/api/admin-profile/all-categories'
  ...
  return (
    <>
        ...
        <header className='container-fluid d-flex flex-column justify-content-center'>
          ...
          <AddTips isOpen={isModalOpen} data={data} cat={cat} isClose={handleClose} endpoint={endpoint} authToken={authToken}
          />
        </div>
    </>
  )
