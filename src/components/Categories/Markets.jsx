...
import TableMarket from '../../utils/TableMarket'
import AddMarket from '../../utils/AddMarket'

const url= 'https://shrtchz.pw/api/admin-profile/all-markets'
const deleteUrl='https://shrtchz.pw/api/admin-profile/delete-market'
const endpoint="https://shrtchz.pw/api/admin-profile/create-market"
  ...
  return (
    <>
        ...
        <header className='container-fluid d-flex flex-column justify-content-center'>
          ...
          <TableMarket data={data} headers={categoryHeaders} selectedRows={selectedRows}  fetchData={fetchData} setSelectedRows={setSelectedRows} setData={setData}/>
